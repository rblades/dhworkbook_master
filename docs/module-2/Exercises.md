...
The exercise may be found [here](../supporting materials/tei.md).
...
9. We will install a command that can convert the json to csv format like so: `$ sudo npm install json2csv --save -g`. Full details about the command are [here](https://github.com/zemirco/json2csv#command-line-interface).
